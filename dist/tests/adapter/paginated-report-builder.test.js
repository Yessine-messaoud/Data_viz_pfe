...
import { buildPaginatedRdl, PAGINATED_RDL_CONSTRAINTS, validateGeneratedRdlShape, validatePaginatedRdl, writePaginatedRdl, writePaginatedRdlSqlServer, } from "../../src/adapter/paginated-report-builder.js";
const spec = {
    id: "spec-paginated",
    version: "0.1.0",
...
test("writePaginatedRdlSqlServer strict echoue si contrainte metier invalide", async () => {
    ...
    await assert.rejects(() => writePaginatedRdlSqlServer(spec, root, {
        server: "localhost\\sqlexpress",
        database: "AdventureWorksDW2022",
        integratedSecurity: true,
        datasetName: "MainDataset",
