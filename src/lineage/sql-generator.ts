import type { AbstractSpec, ColumnRef } from "../spec/abstract-spec.js";

function toSqlColumn(column: ColumnRef): string {
  return `[${column.table}].[${column.column}]`;
}

export function generateSQL(spec: AbstractSpec, visualId: string): string {
